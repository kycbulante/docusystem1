        ...
        <div class="col col-xl-10">
          ...
          <div class="card" style="border-radius: 1rem;">
            ...
            <div class="row g-0">
                ...
                <img src="../image/tup1.png" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body text-black">
                  ...
                  <form action="authcode.php" method="post" >
                    ...
                    <h5 class="fw-normal mb-3 pb-3  d-flex  justify-content-center" style="letter-spacing: 1px;">SIGN IN TO YOUR ACCOUNT</h5>
                    ...
                    <div class="pt-1 mb-4  d-grid gap-2 col-6 mx-auto">
                      <button name="adminlogin_btn" class="btn btn-danger btn-lg btn-block" type="submit">Login</button>
                    </div>
      <br>
